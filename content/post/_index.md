...
- We will hire several PhD students, either through the [Psychology program](https://psychology.yale.edu/graduate/admissions) or the [Neuroscience program](https://medicine.yale.edu/inp/). The application deadline is December 1st! If you’re interested in applying, reach out to **Randolph** at randolph.helfrich@yale.edu
- New paper published in Progress in Neurobiology by **Michael Hahn** on [information coding efficiency during human and rodent sleep](https://www.sciencedirect.com/science/article/pii/S0301008224001084)!
- New [paper](https://www.jneurosci.org/content/44/42/e0171242024.long) published in Journal of Neuroscience spearheaded by **Janna Lendner**. We show that human sleep is not only governed by sleep oscillations, but also by several intrinsic neural timescales that shape the 1/f background activity.
...
- **Gabriela Iwama** and **Frank van Schalkwijk** attended FENS in Vienna, where Gabriela presented new work on learned visual expectations.
